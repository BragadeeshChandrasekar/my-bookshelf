...
<body>
	<h1>
		<center id="heading">  Welcome to Mybookshelf</center>
	</h1>
	<table width="100%">
		<tr>
			<td>Existing user? <a href="Login.jsp"> Login here</a> <br></td>
			<td align="center">New user?<a href="views/Registeration.jsp">
					Register here</a></td>
